...
#define MAX_SPEED_X 20000     //max 25000 for 12V   // Maximun speed in steps/seg
#define MAX_SPEED_Y 20000
...
#define X_AXIS_STEPS_PER_UNIT 2.78    // With 42 teeth GT2 pulley and 1/8 microstepping on drivers
#define Y_AXIS_STEPS_PER_UNIT 2.67    // 200*8 = 1600 steps/rev = 1600/42teeth*2mm = 19.047, using 19 is an error of 1mm every 40cm not too much! and we use int operations...

// Absolute Min and Max robot positions in mm (measured from center of robot pusher)
#define ROBOT_MIN_X 40
#define ROBOT_MIN_Y 130
#define ROBOT_MAX_X 440
#define ROBOT_MAX_Y 385

// This is the center of the table. All units in milimeters
#define ROBOT_CENTER_X 240   // Center of robot. The table is 600x1000mm, so center is 300,500
#define ROBOT_CENTER_Y 230
...
#define ROBOT_INITIAL_POSITION_X 240
#define ROBOT_INITIAL_POSITION_Y 130   // Measured from center of the robot pusher to the table border
